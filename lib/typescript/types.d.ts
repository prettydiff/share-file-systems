...
type copyListItem = [string, string, fileType, number, boolean];
type directoryItem = [string, fileType, string, number, number, directoryData];
...
type requestType = "agent-management" | "agent-online" | "agent-resolve" | "agent-status" | "copy-file-request" | "copy-file" | "copy-list" | "copy" | "error" | "file-system-details" | "file-system-status" | "file-system-string" | "file-system" | "GET" | "hash-agent" | "hash-share" | "invite" | "log" | "message" | "response-no-action" | "settings" | "test-browser";
...
type socketDataType = Buffer | service_agentManagement | service_agentResolve | service_agentStatus | service_copy | service_copy_file | service_copy_fileRequest | service_copy_list | service_error | service_fileSystem | service_fileSystem_details | service_fileSystem_status | service_fileSystem_string | service_hashAgent | service_hashShare | service_invite | service_log | service_message | service_settings | service_testBrowser;
