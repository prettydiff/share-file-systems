...
type socketDataType = agentList | agentOnline | Buffer | copyFileRequest | error | fileStatusMessage | fsDetails | hashAgent | hashShareConfiguration | hashShareResponse | heartbeat | heartbeatUpdate | invite | logData | messageItem[] | NodeJS.ErrnoException | settings | systemDataCopy | systemDataFile | testBrowserRoute;
