...
type modalType = "details" | "export" | "fileEdit" | "fileNavigate" | "invite-accept" | "invite-request" | "message" | "settings" | "share_delete" | "shares" | "textPad";
...
type requestType = copyTypes | hashTypes | heartbeatTypes | inviteAction | "agent-online" | "browser-log" | "error" | "file-list-status-device" | "file-list-status-user" | "forbidden" | "fs" | "GET" | "invite-error" | "message" | "reload" | "response-no-action" | "storage" | "test-browser";
