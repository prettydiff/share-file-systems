...
type agentAction = "add" | "add-modify" | "delete" | "modify" | "rename";
...
type keys_stateDefault = "device" | "message" | "queue" | "ui" | "user";
type keys_ui = "audio" | "brotli" | "color" | "colors" | "fileSort" | "hashDevice" | "hashType" | "hashUser" | "minimizeAll" | "modals" | "modalTypes" | "nameDevice" | "nameUser" | "statusTime" | "storage" | "tutorial" | "zIndex";
...
type modalType = "agent-management" | "configuration" | "details" | "document" | "export" | "file-edit" | "file-navigate" | "invite-ask" | "media" | "message" | "shares" | "socket-list" | "terminal" | "text-pad";
