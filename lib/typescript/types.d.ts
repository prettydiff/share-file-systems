...
type requestType = copyTypes | hashTypes | inviteAction | "agent-online" | "browser-log" | "error" | "file-list-status-device" | "file-list-status-user" | "forbidden" | "fs" | "GET" | "heartbeat" | "invite-error" | "message" | "reload" | "response-no-action" | "settings" | "test-browser";
