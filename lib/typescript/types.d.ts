...
type copyTypes = "copy-file" | "copy-request" | "copy-request-files";
...
type requestType = hashTypes | inviteAction | "agent-online" | "browser-log" | "copy" | "error" | "file-list-status-device" | "file-list-status-user" | "forbidden" | "fs" | "GET" | "heartbeat" | "invite-error" | "message" | "reload" | "response-no-action" | "settings" | "test-browser";
...
type socketDataType = agentList | agentOnline | Buffer | copyFileRequest | error | fileStatusMessage | fsDetails | hashAgent | hashShare | hashShareConfiguration | hashShareResponse | heartbeat | heartbeatUpdate | invite | logData | messageItem[] | NodeJS.ErrnoException | settings | stringData | systemDataCopy | systemDataFile | systemRequestFiles | testBrowserRoute;
