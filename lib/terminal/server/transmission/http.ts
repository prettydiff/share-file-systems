/* lib/terminal/server/transmission/http - A library to process HTTP GET responses. */
...
const http:module_http = {
    get: function terminal_server_transmission_httpGET(url:string, socket:websocket_client):void {
    ...
    post: function terminal_server_transmission_httpPOST(body:string, socket:websocket_client):void {
