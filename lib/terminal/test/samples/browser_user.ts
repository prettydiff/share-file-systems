...
const docFiles:string = "Writing 100.00% complete. 22 files written at size ",
    browserUser:test_browserItem[] = [
        ...
        // On self open user share VM3
        {
            delay: {
                ...
                target: ["innerHTML"],
                type: "property",
                value: "7 directories, 7 files, 0 symbolic links, 0 errors"
            },
            interaction: [
                {
                    event: "click",
        ...
        // On self open user share VM4
        {
            delay: {
                ...
                target: ["innerHTML"],
                type: "property",
                value: "8 directories, 7 files, 0 symbolic links, 0 errors"
            },
            interaction: [
                {
                    event: "click",
