import Queue from "./async-limiter.js";
import * as zlib from "zlib";
import * as bufferUtil from "./buffer-util.js";
import { kStatusCode, NOOP } from "./constants.js";
    ...
    _decompress(data, fin, callback) {
        ...
        if (!this._inflate) {
            ...
            const windowBits = typeof this.params[key] !== 'number'
                ...
                : this.params[key];
            this._inflate = zlib.createInflateRaw(Object.assign(Object.assign({}, this._options.zlibInflateOptions), { windowBits }));
    ...
    _compress(data, fin, callback) {
        ...
        if (!this._deflate) {
            ...
            const windowBits = typeof this.params[key] !== 'number'
                ? zlib.Z_DEFAULT_WINDOWBITS
                : this.params[key];
            this._deflate = zlib.createDeflateRaw(Object.assign(Object.assign({}, this._options.zlibDeflateOptions), { windowBits }));
