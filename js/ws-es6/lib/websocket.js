...
import { BINARY_TYPES, EMPTY_BUFFER, GUID, kStatusCode, kWebSocket, NOOP } from "./constants.js";
import EventTarget from "./event-target.js";
import { format, parse } from "./extension.js";
import { toBuffer } from "./buffer-util.js";
const EventEmitter = internal;
...
class WebSocket extends EventEmitter {
    ...
    send(data, options, cb) {
        ...
        const opts = Object.assign({ binary: typeof data !== 'string', mask: !this._isServer, compress: true, fin: true }, options);
        if (!this._extensions[PerMessageDeflate.extensionName]) {
            opts.compress = false;
        }
...
function initAsClient(websocket, address, protocols, options) {
    ...
    opts.host = parsedUrl.hostname.startsWith('[')
        ...
        : parsedUrl.hostname;
    opts.headers = Object.assign({ 'Sec-WebSocket-Version': opts.protocolVersion, 'Sec-WebSocket-Key': key, Connection: 'Upgrade', Upgrade: 'websocket' }, opts.headers);
