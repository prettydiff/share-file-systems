...
* Directory *[../lib/terminal/test/samples](../lib/terminal/test/samples)*
   ...
   - **[../lib/terminal/test/samples/browser_machines.ts](../lib/terminal/test/samples/browser_machines.ts)**                 - An object expressing a map of the various remote machines.
   - **[../lib/terminal/test/samples/browser_mainMenu.ts](../lib/terminal/test/samples/browser_mainMenu.ts)**                 - A convenience function that opens the main menu while in browser tests.
