...
* Directory *[../lib/terminal/test/application](../lib/terminal/test/application)*
   ...
   - **[../lib/terminal/test/application/browser_projectDirectory.ts](../lib/terminal/test/application/browser_projectDirectory.ts)** - A convenience function that tests a file navigation modal to go to the project's location for browser tests.
