...
* **heartbeat** - Provides the remote response for the *heartbeat-update* service.
* **heartbeat-delete-agents** - Instructions for remote agents to delete agents as generated by *delete-agents* service.
* **heartbeat-response** - The completed round trip of the *heartbeat-update* service, the response is generated by the service *heartbeat*.  This service changes share data as necessary from the remote agents.
