...
### Examples
1. `node js/application agents`
   - Lists all agent data.
1. `node js/application agents device`
   - Lists all device type agent data.
1. `node js/application agents user`
   - Lists all user type agent data.
1. `node js/application agents "desktop computer"`
   - Lists any agent whose names contain the search string
1. `node js/application agents "16f07e8ed7225f07912da48e0d51308e8fbf9dafc89d8accaa58abc1da8a2832a046082bfc2534eb4933a00bd673019cb90437c8a94cc0d0adaf9cff40c5083b"`
...
### Examples
1. `node js/application test_agent a5908e8446995926ab2dd037851146a2b3e6416dcdd68856e7350c937d6e92356030c2ee702a39a8a2c6c58dac9adc3d666c28b96ee06ddfcf6fead94f81054e`
   - This will test a connection to the specified agent.
1. `node js/application test_agent list`
   - Specifying the parameter 'list' will output a list of all agent hashes, names, and IP addresses by agent type.
1. `node js/application test_agent device`
   - An argument of 'device' will test connectivity on each device agent.
1. `node js/application test_agent user`
   - An argument of 'user' will test connectivity on each user agent.
1. `node js/application test_agent all`
